...
def submitHomer(outfiles, mode, genome):
    ...
    '''
    if genome == 'hg38':
        HOMER_COMMAND = 'ml homer/4.10 python3; annotatePeaks.pl {file} /apps/homer/4.10/share/homer/4.10-0/.//data/genomes/hg38/ -organism human -annStats {file2}'
    if genome == 'mm9':
        HOMER_COMMAND = 'ml homer/4.10 python3; annotatePeaks.pl {file} /apps/homer/4.10/share/homer/4.10-0/.//data/genomes/mm9/ -organism mouse -annStats {file2}'
    if genome == 'mm10':
        HOMER_COMMAND = 'ml homer/4.10 python3; annotatePeaks.pl {file} /apps/homer/4.10/share/homer/4.10-0/.//data/genomes/mm10/ -organism mouse -annStats {file2}'
    if genome == 'tair10':
        HOMER_COMMAND = 'ml homer/4.10 python3; annotatePeaks.pl {file} /apps/homer/4.10/share/homer/4.10-0/.//data/genomes/tair10/ -organism  Arabidopsis -annStats {file2}'
    if genome == 'rn6':
        HOMER_COMMAND='module load homer/4.10 python3; annotatePeaks.pl {file} /apps/homer/4.10/share/homer/4.10-0/.//data/genomes/rn6/ -organism rat -annStats {file2}'
...
parser.add_argument('-g', '--genome', help = 'Genome to be used by HOMER for the annotation. Choices are hg38, mm9, mm10, tair10 or rn6')
